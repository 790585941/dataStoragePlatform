...
-- ----------------------------
-- Table structure for dataStoragePlatform_file
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_file`;

CREATE TABLE `dataStoragePlatform_file`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_share
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_share`;
CREATE TABLE `dataStoragePlatform_share`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_share_file
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_share_file`;
CREATE TABLE `dataStoragePlatform_share_file`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_user
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_user`;
CREATE TABLE `dataStoragePlatform_user`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_user_file
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_user_file`;
CREATE TABLE `dataStoragePlatform_user_file`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `dataStoragePlatform_user_search_history`;
CREATE TABLE `dataStoragePlatform_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for dataStoragePlatform_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `dataStoragePlatform_file_chunk`;
CREATE TABLE `dataStoragePlatform_file_chunk`
(
...
-- ----------------------------
-- Table structure for dataStoragePlatform_error_log
-- ----------------------------

DROP TABLE IF EXISTS `dataStoragePlatform_error_log`;
CREATE TABLE `dataStoragePlatform_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
