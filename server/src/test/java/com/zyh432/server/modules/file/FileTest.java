package com.zyh432.server.modules.file;
...
import com.zyh432.server.modules.user.context.UserLoginContext;
...
public class FileTest {
    ...
    public void testQueryUserFileListSuccess(){
        ...
        Assert.isTrue(Collections.isEmpty(result));
    }
    ...
    public void testCreateFolderSuccess(){
        ...
        context.setParentId(userInfoVo.getRootFileId());
        context.setUserId(userId);
        context.setFolderName("fold-name");
    ...
    public void testUpdateFilenameFailByWrongFileId(){
        ...
        updateFilenameContext.setNewFilename("fold-name-new");
    ...
    public void testUpdateFilenameFailByWrongFilename(){
        ...
        updateFilenameContext.setFileId(fileId);
        updateFilenameContext.setUserId(userId);
        updateFilenameContext.setNewFilename("fold-name");
    ...
    public void testUpdateFilenameFailByFilenameUnAvailable(){
        ...
        context.setParentId(userInfoVo.getRootFileId());
        context.setUserId(userId);
        context.setFolderName("fold-name-1");
        ...
        context.setParentId(userInfoVo.getRootFileId());
        context.setUserId(userId);
        context.setFolderName("fold-name-2");
        ...
        updateFilenameContext.setFileId(fileId);
        updateFilenameContext.setUserId(userId);
        updateFilenameContext.setNewFilename("fold-name-1");
    ...
    public void testUpdateFilenameSuccess(){
        ...
        context.setParentId(userInfoVo.getRootFileId());
        context.setUserId(userId);
        context.setFolderName("fold-name-old");
    ...
    public void testUploadSuccess(){
        ...
        List<DataStoragePlatformUserFileVO> fileList = iUserFileService.getFileList(queryFileListContext);
    ...
    public void testTransferFileSuccess() {
        ...
        queryFileListContext.setUserId(userId);
        queryFileListContext.setDelFlag(DelFlagEnum.NO.getCode());
        List<DataStoragePlatformUserFileVO> records = iUserFileService.getFileList(queryFileListContext);
