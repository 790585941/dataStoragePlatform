...
public class UserController {
    ...
    public Data register(@Validated @RequestBody UserRegisterPO userRegisterPO){
        ...
        return Data.data(IdUtil.encrypt(userId));
    }
    ...
    @LoginIgnore
    @PostMapping("/login")
    public Data login(@Validated @RequestBody UserLoginPO userLoginPO){
    ...
    public Data checkAnswer(@Validated @RequestBody CheckAnswerPO checkAnswerPO) {
    ...
    @LoginIgnore
    public Data resetPassword(@Validated @RequestBody ResetPasswordPO resetPasswordPO){
    ...
    public Data changePassword(@Validated @RequestBody ChangePasswordPO changePasswordPO){
    ...
    @GetMapping("/")
    public Data<UserInfoVO> info(){
        UserInfoVO userInfoVO= iUserService.info(UserIdUtil.get());
        return Data.data(userInfoVO);
    }
}
