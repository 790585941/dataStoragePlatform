package com.zyh432.storage.engine.fastdfs.config;
...
@Data
@ConfigurationProperties(prefix = "com.zyh432.storage.engine.fastdfs")
...
public class FastDFSStorageEngineConfig {
    ...
    public TrackerConnectionManager trackerConnectionManager(FdfsConnectionPool fdfsConnectionPool) {
        ...
        if (CollectionUtils.isEmpty(getTrackerList())) {
            throw new DataStoragePlatformFrameworkException("the tracker list is empty!");
        }
