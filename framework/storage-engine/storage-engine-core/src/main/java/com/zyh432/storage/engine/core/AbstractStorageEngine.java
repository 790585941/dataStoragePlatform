package com.zyh432.storage.engine.core;
...
public abstract class AbstractStorageEngine implements StorageEngine{
    ...
    protected Cache getCache() {
        if (Objects.isNull(cacheManager)) {
            throw new DataStoragePlatformBusinessException("具体的缓存实现需要引用到项目中");
        }
        return cacheManager.getCache(CacheConstants.dataStoragePlatform_CACHE_NAME);
    }
