package com.zyh432.lock.core.asspect;
...
public class LockAspect implements ApplicationContextAware {
    ...
    @Pointcut(value = "@annotation(com.zyh432.lock.core.annotation.Lock)")
    ...
    public Object aroundLock(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        if (Objects.isNull(lock)) {
            ...
            throw new DataStoragePlatformFrameworkException("aroundLock get lock fail.");
        }
        ...
        try {
            ...
            throw new DataStoragePlatformFrameworkException("aroundLock tryLock fail.");
        } catch (Throwable e) {
            log.error("lock aspect tryLock exception.",e);
            throw new DataStoragePlatformFrameworkException("aroundLock tryLock fail.");
        } finally {
