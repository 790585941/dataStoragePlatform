package com.zyh432.cache.caffeine.test;

import cn.hutool.core.lang.Assert;
import com.zyh432.cache.caffeine.test.config.CaffeineCacheConfig;
import com.zyh432.cache.caffeine.test.instance.CacheAnnotationTester;
...
public class CaffeineCacheTest {
    ...
    public void caffeineCacheAnnotationTest() {
        for (int i = 0; i < 2; i++) {
            cacheAnnotationTester.testCacheable("panghu");
        }
    }
