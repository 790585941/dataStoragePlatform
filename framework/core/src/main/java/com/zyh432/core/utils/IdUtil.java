...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new DataStoragePlatformBusinessException("AES128Util.aesDecode fail");
        }
        throw new DataStoragePlatformBusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(DataStoragePlatformConstants.COMMON_SEPARATOR).splitToList(decryptIdStr);
    ...
    public static void main(String[] args) {
        System.out.println(encrypt(1770852155768066048L));
